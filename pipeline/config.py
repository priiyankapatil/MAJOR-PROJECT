...
BASE_DIR        = os.path.dirname(_curr_dir) if os.path.basename(_curr_dir) == "pipeline" else _curr_dir
RAW_PDF_DIR     = os.path.join(BASE_DIR, "data", "raw pdf")
EXTRACTED_DIR   = os.path.join(BASE_DIR, "data", "extracted_text")
CHUNKS_DIR      = os.path.join(BASE_DIR, "data", "chunks")
METADATA_DIR    = os.path.join(BASE_DIR, "data", "metadata")
VECTOR_STORE    = os.path.join(BASE_DIR, "data", "vector_store") if os.path.exists(os.path.join(BASE_DIR, "data", "vector_store")) else os.path.join(BASE_DIR, "vector_store")
GRAPH_DIR       = os.path.join(BASE_DIR, "data", "knowledge_graph") if os.path.exists(os.path.join(BASE_DIR, "data", "knowledge_graph")) else os.path.join(BASE_DIR, "knowledge_graph")
